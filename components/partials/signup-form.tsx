        ...
        <div className={cn("flex flex-col gap-6", className)}>
            <div className="flex flex-col items-center gap-1 text-center">
                ...
                <p className="text-muted-foreground text-sm text-balance">
                    Join Beyond today and start creating.
                </p>
            </div>
            ...
            <form onSubmit={handleSignUp} className="grid gap-4">
                <FieldGroup>
                    <Field>
                        <FieldLabel htmlFor="name text-xs uppercase font-bold tracking-wider text-muted-foreground/80">Full Name</FieldLabel>
                    ...
                    <Button type="submit" className="w-full h-11" disabled={isSignUpLoading || isLoading}>
                        {isSignUpLoading ? (
                            <>
