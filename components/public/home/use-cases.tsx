    ...
    return (
        <section className="py-20 px-6 border-t border-border/40">
            <div className="max-w-6xl mx-auto space-y-12">
                ...
                {/* CTA Section */}
                <div className="mt-16 bg-gradient-to-r from-secondary/40 via-secondary/20 to-secondary/40 rounded-2xl border border-border/40 p-12 text-center space-y-6">
                    ...
                    <button className="bg-white text-black hover:bg-gray-100 font-semibold py-3 px-8 rounded-full transition inline-block">
